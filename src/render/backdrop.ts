 ...
 *
 * Инвариант 1: ни одна ступень не совпадает с цветом орбитального объекта
 * (`gray[9]`) — на его уникальности держится проверка прохода спутника.
 *
 * Инвариант 2: облака НЕ `gray[8]` — та ступень у иридия, а иридий считают
 * подсчётом пикселей, и облака Земли добавляли бы в кучу тринадцать своих.
 */

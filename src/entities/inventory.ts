 ...
 *
 * Счётчики по материалам с ОБЩИМ пределом, а не слоты: ячейка мира это байт
 * материала, и уносить можно только «сколько ячеек какого вещества». Слоты
 * ввели бы сущность, которой в модели нет.
 *
 * Предел существует ради ходки к приёмнику: без него расположение модуля
 * на карте перестаёт что-либо значить.
 *
 * Названий веществ инвентарь не знает — читает таблицу материалов.
 */
export class Inventory {
   ...
   * условие сохранения вещества: сбор обязан оставить в мире то, что не влезло.
   * Забирает сколько может, а не отказывается целиком.
   */
